...
const CSS = `
.gr { --blue:#2563eb; --blue-dark:#1d4ed8; --blue-light:#eff6ff; --blue-mid:#dbeafe;
...
.gr { font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif; color:var(--gray-900); }
.gr .hero {
...
.gr .hero h1 span { color:var(--blue); }
.gr .hero p { font-size:16px; color:var(--gray-600); max-width:520px; margin:0 auto 28px; line-height:1.65; }
.gr .hero-stats { display:flex; gap:12px; justify-content:center; flex-wrap:wrap; }
.gr .stat-chip {
  background:white; border:1px solid var(--gray-200);
  border-radius:12px; padding:10px 18px;
  display:flex; align-items:center; gap:10px; box-shadow:var(--shadow);
}
.gr .stat-chip .num { font-size:20px; font-weight:800; color:var(--blue); }
.gr .stat-chip .lbl { font-size:11px; color:var(--gray-600); line-height:1.3; text-align:left; }
.gr .tabs-header {
...
.gr .tab-btn.active { background:white; color:var(--blue); box-shadow:0 1px 4px rgba(0,0,0,.12); }
.gr .sec { padding:0 0 48px; max-width:1060px; margin:0 auto; }
.gr .sec-title {
  font-size:20px; font-weight:800; color:var(--gray-900);
  margin-bottom:4px; display:flex; align-items:center; gap:8px;
}
.gr .sec-sub { font-size:13px; color:var(--gray-600); margin-bottom:24px; }
...
.gr .card {
  ...
  animation:grFadeUp .4s forwards;
}
.gr .card:hover { box-shadow:var(--shadow-lg); transform:translateY(-2px); border-color:var(--blue-mid); }
@keyframes grFadeUp { to { opacity:1; transform:translateY(0); } }
.gr .card-icon {
  width:42px; height:42px; border-radius:11px;
  display:flex; align-items:center; justify-content:center;
  font-size:19px; margin-bottom:12px; flex-shrink:0;
}
.gr .card-title { font-size:14px; font-weight:700; color:var(--gray-900); margin-bottom:5px; }
.gr .card-desc { font-size:13px; color:var(--gray-600); line-height:1.6; }
.gr .tags { display:flex; flex-wrap:wrap; gap:4px; margin-top:12px; }
.gr .tag { font-size:11px; font-weight:500; padding:3px 8px; border-radius:99px; background:var(--gray-100); color:var(--gray-700); }
.gr .tag.blue { background:var(--blue-light); color:var(--blue); }
.gr .tag.green { background:#d1fae5; color:var(--green); }
.gr .tag.violet { background:#ede9fe; color:var(--violet); }
.gr .tag.orange { background:#fef3c7; color:var(--orange); }
.gr .highlight {
  background:linear-gradient(135deg,var(--blue),#4f46e5); color:white;
  border-radius:16px; padding:28px 32px; margin:32px 0;
  display:flex; align-items:flex-start; gap:18px;
}
.gr .highlight .hi { font-size:32px; flex-shrink:0; margin-top:2px; }
.gr .highlight h3 { font-size:17px; font-weight:700; margin-bottom:5px; }
.gr .highlight p { font-size:13px; opacity:.85; line-height:1.65; }
.gr .highlight ul { margin-top:8px; padding-left:16px; font-size:13px; opacity:.9; }
.gr .highlight ul li { margin-bottom:3px; }
.gr .flow-wrap { background:var(--gray-50); border-radius:16px; padding:18px 22px; margin:16px 0; }
.gr .flow-step { display:flex; gap:14px; align-items:flex-start; padding:12px 0; border-bottom:1px solid var(--gray-100); }
.gr .flow-step:last-child { border-bottom:none; }
.gr .step-num {
  width:28px; height:28px; border-radius:50%; flex-shrink:0;
  background:var(--blue); color:white; font-size:12px; font-weight:700;
  display:flex; align-items:center; justify-content:center; margin-top:2px;
}
.gr .step-title { font-size:13px; font-weight:700; color:var(--gray-900); margin-bottom:2px; }
.gr .step-desc { font-size:13px; color:var(--gray-600); line-height:1.55; }
.gr .status-flow { display:flex; flex-wrap:wrap; align-items:center; gap:5px; padding:14px; background:var(--gray-50); border-radius:12px; margin:10px 0; }
.gr .sp { padding:3px 10px; border-radius:99px; font-size:11px; font-weight:600; }
.gr .sp-arr { color:var(--gray-400); font-size:13px; }
.gr .sp.red { background:#fee2e2; color:var(--red); }
.gr .sp.yellow { background:#fef3c7; color:var(--orange); }
.gr .sp.blue { background:var(--blue-mid); color:var(--blue); }
.gr .sp.indigo { background:#e0e7ff; color:#4338ca; }
.gr .sp.green { background:#d1fae5; color:var(--green); }
.gr .sp.orange { background:#ffedd5; color:#c2410c; }
.gr .mockup { background:var(--gray-50); border:1px solid var(--gray-200); border-radius:14px; padding:18px; margin:14px 0; font-size:13px; }
.gr .mockup-bar { display:flex; align-items:center; gap:7px; background:white; border:1px solid var(--gray-200); border-radius:8px; padding:9px 12px; margin-bottom:10px; }
.gr .mock-dot { width:8px; height:8px; border-radius:50%; }
.gr .mockup-row { display:flex; justify-content:space-between; align-items:center; padding:9px 12px; background:white; border-radius:7px; border:1px solid var(--gray-100); margin-bottom:5px; font-size:12px; color:var(--gray-700); }
.gr .divider { height:1px; background:var(--gray-100); margin:0 0 40px; max-width:1060px; }
.gr .admin-banner {
...
.gr .admin-banner .abi { font-size:32px; flex-shrink:0; }
.gr .admin-banner h3 { font-size:17px; font-weight:700; margin-bottom:5px; }
.gr .admin-banner p { font-size:13px; opacity:.8; line-height:1.6; }
...
export default function GuidePage() {
  ...
  useEffect(() => {
    ...
    el.id = 'guide-page-css'
    el.textContent = CSS
    document.head.appendChild(el)
    return () => document.getElementById('guide-page-css')?.remove()
  }, [])
  ...
  return (
    <div ref={rootRef} className="gr p-3 md:p-6">
      ...
      <div className="tabs-header">
        <button className={`tab-btn${tab === 'terapeuta' ? ' active' : ''}`} onClick={() => switchTab('terapeuta')}>🩺 Para Terapeutas</button>
        <button className={`tab-btn${tab === 'admin' ? ' active' : ''}`} onClick={() => switchTab('admin')}>🛡️ Para Administradores</button>
      </div>
